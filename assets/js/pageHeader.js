    ...
    <div class="auto-container">
      <div class="upper-inner clearfix">
        ...
        <ul class="info-box pull-right clearfix">
          ...
          <li class="btn-box">
            <a href="technov2.html" class="theme-btn-one" target="_blank"
              >Technocrats V.2</a
            >
          </li>
        </ul>
            ...
            >
              <ul class="navigation clearfix">
                ...
                <li class="dropdown">
                  ...
                  <ul>
                    <li><a href="about.html">Ongoing</a></li>
                    <li><a href="research.html">Previous</a></li>
                    <li><a href="books.html">Program Project</a></li>
                  </ul>
                </li>
                ...
                <li class="dropdown">
                  ...
                  <ul>
                    <li class="dropdown">
                      <a href="team.html">Executive Panel</a>
                      <ul>
                        <li>
                    ...
                    <li><a href="team-details.html">Ad-Hoc</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="../../index.html">Events</a>
                  <ul>
                    <li><a href="events.html">National Events</a></li>
                    <li><a href="events.html">Intra Events</a></li>
                    <li><a href="events.html">Inter Events</a></li>
                  </ul>
                </li>
